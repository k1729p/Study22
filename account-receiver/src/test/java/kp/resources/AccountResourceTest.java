...
/**
 * The unit tests for the {@link AccountResource}.<br/>
 * It uses mocked services: {@link AccountMongoService} and
 * {@link AccountPostgresService}.
 */
@QuarkusTest
class AccountResourceTest {
	...
	void shouldReadAccountFromPostgres() {
		...
		final RequestSpecification requestSpecification = RestAssured.given().pathParam("name", ACCOUNT_NAME);
		// WHEN
	...
	/**
	 * Should not find account in PostgreSQL database.<br/>
	 * From the account in MongoDB database it should create<br/>
	...
	/**
	 * Should not return account when it failed the account creation in PostgreSQL
	 * database.
	 */
	@Test
